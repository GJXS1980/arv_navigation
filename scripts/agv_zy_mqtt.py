...
class MoveBaseDoor():
    ...
    #   去岸吊导航函数
    def and_goal(self, i): 
        waypointsx = list([-0.89467215538, -2.83146190643, -2.79664230347])
        waypointsy = list([-4.17809247971, -3.87872600555, -5.96632671356])

        waypointsaw = list([0.999998178138, -0.705385623035, -0.703590820781])
        waypointsw = list([-0.00190885348296, 0.708823760053, 0.710605345401])
