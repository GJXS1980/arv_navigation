...
class NavTest():
	...
	self.agv_ready_state = 0
        rospy.Subscriber('agv_state', Int32, self.agv_ready)
	...
	rospy.wait_for_message('agv_state', Int32)
        ...
        # 确保初始化成功
        while initial_pose.header.stamp == "" and self.agv_ready_state == 1:
            rospy.sleep(1)
    ...
    def agv_ready(self,data):
	self.agv_ready_state = data.data
